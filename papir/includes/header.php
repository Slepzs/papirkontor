    ...
    <nav class="uk-navbar-container"  uk-navbar="dropbar: false">
      ...
      <div class="uk-navbar-right">
          <ul class="uk-navbar-nav box-animation aktive">
              <li><a class="box-target <?= ($title == 'Forsiden') ? "uk-active uk-animation-fade" : ""; ?>" href="index">Forside</a></li>
              <li>
                  <a class="box-target <?= ($title == 'Produkter') ? "uk-active uk-animation-fade" : ""; ?>" href="produkter">Produkter</a>
                  <div class="uk-navbar-dropdown uk-navbar-dropdown-width-1">
                    <div class="uk-navbar-dropdown-grid uk-child-width-1-1" uk-grid>
                      <ul class="uk-nav uk-navbar-dropdown-nav">
                          <li><a class="<?= ($title == 'T-shirt') ? "uk-active uk-animation-fade" : ""; ?>" href="t-shirt">T-shirt</a></li>
                          <li><a class="<?= ($title == 'Hoodies') ? "uk-active uk-animation-fade" : ""; ?>" href="hoodies">Hoodies</a></li>
                          <li><a class="<?= ($title == 'Skilte') ? "uk-active uk-animation-fade" : ""; ?>" href="skilte">Skilte</a></li>
                          <li><a class="<?= ($title == 'Bannere') ? "uk-active uk-animation-fade" : ""; ?>" href="banner">Banner</a></li>
                      </ul>
                    </div>
                  </div>
              </li>
              <li><a class="box-target <?= ($title == 'Om os') ? "uk-active uk-animation-fade" : ""; ?>" href="om-os">Om os</a></li>
              <li><a class="box-target <?= ($title == 'Kontakt') ? "uk-active uk-animation-fade" : ""; ?>" href="kontakt">Kontakt</a></li>
              <?php  if(isset($_SESSION['id_kunde'])) { ?><li><a class="box-target <?= ($title == 'Check ud') ? "uk-active uk-animation-fade" : ""; ?>" href="checkout"><i class="fas fa-shopping-cart"></i><?php checkudcart(); ?></a></li><?php }; ?>
          </ul>
      </div>
  <!--  </div> -->
  </div>
