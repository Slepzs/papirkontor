...
<div class="wrapper">
  <div class="content-wrapper">
    ...
    <div class="breadcrums">
      <p><a href="index.php">Forside</a>/<a href="ydelser.php"> Ydelser</a>/<a href="skilte.php"> Skilte</a></p>
    </div>
    ...
    <h2>Interesseret i at vide mere om vores skilte?</h2>
    <ul class="uk-list uk-list-striped">
    <li><span class="bold">Længde:</span> 9.5m</li>
    <li><span class="bold">Bredde:</span> 5m</li>
