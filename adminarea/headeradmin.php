  ...
  <div class="nav-wrapper">
    ...
    <nav class="uk-navbar-container"  uk-navbar="dropbar: false">
      ...
      <div class="uk-navbar-right">
          <ul class="uk-navbar-nav box-animation">
              <li><a class="box-target <?= ($title == 'Admin-signup') ? "uk-active uk-animation-fade" : ""; ?>" href="../admin-signup.php">Opret bruger</a></li>
              <li><a class="box-target <?= ($title == 'Forsiden') ? "uk-active uk-animation-fade" : ""; ?>" href="../admin-login.php">Login</a></li>
              ...
              <li><a class="box-target <?= ($title == 'Kontakt') ? "uk-active uk-animation-fade" : ""; ?>" href="logudadmins.php">Log ud</a></li>
          </ul>
      </div>
  <!--  </div> -->
  </div>
          ...
          <div id="offcanvas-nav" uk-offcanvas="flip: true">
              <div class="uk-offcanvas-bar">
                  ...
                  <ul class="uk-nav uk-nav-default">
                      <li class="<?= ($title == 'Forsiden') ? "uk-active" : ""; ?>"><a href="#"><span class="uk-margin-small-right" uk-icon="icon: home"></span>Forside</a></li>
                      ...
                      <li class="<?= ($title == 'Om os') ? "uk-active" : ""; ?>"><a href="#">Om os</a></li>
                      <li class="<?= ($title == 'Kontakt') ? "uk-active" : ""; ?>"><a href="#">Kontakt</a></li>
                      <li class="uk-nav-divider"></li>
                      <li class="uk-nav-header">Andet</li>
                      <li><a href="#"><span class="uk-margin-small-right" uk-icon="icon: settings"></span> Sitemap</a></li>
                      <li><a href="#"><span class="uk-margin-small-right" uk-icon="icon: thumbnails"></span> Forhandlingsbetingelsers</a></li>
